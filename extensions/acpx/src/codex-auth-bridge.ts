...
async function prepareIsolatedCodexHome(
  ...
  const sourceHome = resolveCodexSourceHome(bridgeConfig.sourceHome);
  if (bridgeConfig.auth) {
  ...
  if (bridgeConfig.bootstrapFiles) {
...
export async function prepareAcpxCodexAuthConfig(params: {
  ...
  await prepareIsolatedCodexHome(codexBaseDir, params.pluginConfig.codexHomeBridge);
