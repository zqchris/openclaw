...
export const FIELD_HELP: Record<string, string> = {
  ...
  "channels.discord.inboundWorker.runTimeoutMs":
    "Optional queued Discord inbound worker timeout in ms. This is separate from Carbon listener timeouts; can be disabled with 0. Set per account via channels.discord.accounts.<id>.inboundWorker.runTimeoutMs.",
  "channels.discord.eventQueue.listenerTimeout":
    "Canonical Discord listener timeout control in ms for gateway normalization/enqueue handlers. Set per account via channels.discord.accounts.<id>.eventQueue.listenerTimeout.",
